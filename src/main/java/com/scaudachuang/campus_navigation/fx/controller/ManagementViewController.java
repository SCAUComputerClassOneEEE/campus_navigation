...
public class ManagementViewController implements Initializable {
    ...
    private void Admin(){
        ...
        admin.setOnClosed(new EventHandler<Event>() {
            @Override
    ...
    private void Building(){
        ...
        building.setOnClosed(new EventHandler<Event>() {
            @Override
            public void handle(Event event) {
                buFlag = true;
            }
    ...
    private void Comment(){
        ...
        comment.setOnClosed(new EventHandler<Event>() {
            @Override
            public void handle(Event event) {
                cmFlag = true;
            }
    ...
    private void User() {
        ...
        user.setOnClosed(new EventHandler<Event>() {
            @Override
            public void handle(Event event) {
                usFlag = true;
            }
